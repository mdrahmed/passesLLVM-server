...
entry:
  ...
  %add = add nsw i32 %0, 2
  %call1 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.1, i32 noundef %add)
...
!4 = !{!"clang version 15.0.0 (https://github.com/llvm/llvm-project.git df6afee9859f982fa927dc90398e82d689f19db6)"}
!5 = !{!6, !6, i64 0}
!6 = !{!"int", !7, i64 0}
